        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card shadow-sm border-0">
                    <a href="/pokemons/{{ $pokemon['id'] }}" class="text-decoration-none text-dark">
                        <img src="/images/{{ str_pad($pokemon['id'], 3, 0,STR_PAD_LEFT) }}.png" class="card-img-top p-3" alt="">
                        <div class="card-body text-center">
                            <h5 class="card-title fw-bold">{{ $pokemon['name']['english'] }}</h5>
                        </div>
                    </a>
                </div>
            </div>
